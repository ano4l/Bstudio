(function () {
  ...
  const SERVICES = {
    ...
    "clean-installation-curling": { title: "Basic installation + Curling", price: "R950,00", duration: "1 hour 55 minutes", image: "service-portfolio/image00010.jpeg", description: "A basic installation finished with curling.", prep: "Please come with your wig lines already done.", includes: "Basic installation and curling finish." },
    "basic-installation-defining-curls": { title: "Basic installation + defining curls", price: "R700,00", duration: "1 hour 10 minutes", image: "service-portfolio/image00018.jpeg", description: "A basic installation finished with defining curls.", prep: "Preparation details are confirmed when your request is reviewed.", includes: "Basic installation with defining curls." },
